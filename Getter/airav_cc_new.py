...
import json
from Getter import airav_cc
import Function.config as cf


def main(number, appoint_url='', log_info='', req_web='', language='zh_cn'):
    config = cf.get_config()
    all_language = config.get('title_language') + config.get('outline_language') + config.get('actor_language') + config.get('tag_language') + config.get('series_language') + config.get('studio_language')
