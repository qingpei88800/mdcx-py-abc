...
from Function.getHtml import get_dmm_trailer
import urllib3
...
def main(number, appoint_url='', log_info='', req_web='', language='jp'):
    ...
    try:                                                                        # 捕获主动抛出的异常
        ...
        debug_info = str(e)
        dic = {'title': '', 'cover': '', 'website': '', 'log_info': log_info, 'error_info': debug_info, 'req_web': req_web + '(%ss) ' % (round((time.time() - start_time), ))}
