...
def get_outline(html):
    ...
    rep_list = [
        '(中文字幕1280x720)', '(日本同步最新‧中文字幕1280x720)', '(日本同步最新‧中文字幕)', '(日本同步最新‧完整激薄版‧中文字幕1280x720)', '＊日本女優＊ 劇情做愛影片 ＊完整日本版＊', '＊日本女優＊ 剧情做爱影片 ＊完整日本版＊', '&nbsp;', '<br/>', '<p>', '</p>', '<style type=\"text/css\"><!--td {border: 1px solid #ccc;}br {mso-data-placement:same-cell;}-->\n</style>\n',
        '<table style=\"border-collapse:collapse; width:54pt; border:none\" width=\"72\">\n\t<colgroup>\n\t\t<col style=\"width:54pt\" width=\"72\" />\n\t</colgroup>\n\t<tbody>\n\t\t<tr height=\"22\" style=\"height:16.5pt\">\n\t\t\t<td height=\"22\" style=\"border:none; height:16.5pt; width:54pt; padding-top:1px; padding-right:1px; padding-left:1px; vertical-align:middle; white-space:nowrap\" width=\"72\"><span style=\"font-size:12pt\"><span style=\"color:black\"><span style=\"font-weight:400\"><span style=\"font-style:normal\"><span style=\"text-decoration:none\"><span style=\"font-family:新細明體,serif\">', '</span></span></span></span></span></span></td>\n\t\t</tr>\n\t</tbody>\n</table>', '★ (请到免费赠片区观赏)'
    ]
...
def main(number, appoint_url='', log_info='', req_web='', language=''):
    ...
    avsex_website = config.get('avsex_website')
    if avsex_website:
