...
def main(number, appoint_url='', log_info='', req_web='', language='jp'):
    ...
    if real_url:
        ...
        real_url_list = [f"https://faleno.jp/top/works/{number_lo_noline}/", f"https://faleno.jp/top/works/{number_lo}/", f"https://falenogroup.com/works/{number_lo}/", f"https://falenogroup.com/works/{number_lo_noline}/"]
    log_info += '\n    🌐 faleno'
    mosaic = '有码'
    try:                                                                        # 捕获主动抛出的异常
