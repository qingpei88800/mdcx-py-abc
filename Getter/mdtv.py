...
import json
from Function.getHtml import post_html, get_html
from Getter.guochan import get_number_list, get_lable_list, get_actor_list
...
def main(number, appoint_url='', log_info='', req_web='', language='zh_cn', file_path='', appoint_number=''):
    ...
    mdtv_website = config.get('mdtv_website')
